      ...
      <div className="relative bg-gradient-to-br from-violet-900 via-purple-900 to-fuchsia-900 text-white overflow-hidden pb-16 pt-12 lg:pt-20">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="mb-6 flex justify-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-sm font-medium animate-fade-in text-white">
              <span className="text-yellow-300">✨</span> {promos[activePromo]}
            </div>
          </div>

          <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tight leading-tight capitalize bg-clip-text text-transparent bg-gradient-to-b from-white to-purple-200 drop-shadow-sm pb-1">
            {displayName}
          </h1>
      ...
      <div className="container mx-auto px-4 mt-8 lg:mt-12">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 px-6 bg-white rounded-3xl shadow-sm border border-gray-100 max-w-2xl mx-auto">
            ...
            <p className="text-gray-500 mb-8 max-w-sm mx-auto text-sm">We couldn't find any products in this category matching your criteria.</p>
            ...
            {totalPages > 1 && (
              <div className="mt-12 flex justify-center items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed bg-white text-gray-700"
                >
                  Previous
                </button>
