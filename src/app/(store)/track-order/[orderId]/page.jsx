...
export default function OrderTrackingPage() {
  ...
  const fetchOrder = async (id) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/orders/${id.trim()}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white py-12 px-4 sm:px-6 lg:px-8 text-gray-900">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent mb-3 pb-1">
            Track Your Order
          </h1>
        ...
        {order && (
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                  ...
                  <React.Fragment key={step.key}>
                    <div className="flex flex-col items-center">
                      ...
                      <span className={`text-[10px] sm:text-xs text-center ${
                        step.active ? 'font-semibold text-purple-600' : 'text-gray-600'
                      }`}>
                        {step.label}
                      </span>
                    </div>
            ...
            <div className="p-6 border-t text-gray-800">
            ...
            <div className="p-6 border-t text-gray-800">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 space-y-2">
                ...
                {order.giftWrap && (
                  <div className="flex justify-between text-gray-600">
                    <span>Gift Wrap</span>
                    <span>Rs. {(order.giftWrapCost || 0).toLocaleString()}</span>
                  </div>
                )}
