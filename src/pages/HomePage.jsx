...
const API_PRODUCTS_ENDPOINT = import.meta.env.VITE_API_PRODUCTS || window.__APP_CONFIG__?.API_PRODUCTS || '/api/products';
...
function HomePage() {
    ...
    // SEO
    const seoCanonical = `https://www.coolcache.app/${currentPage > 1 ? `?page=${currentPage}` : ''}`;

    return (
        <>
            <Navbar />
            {/* Cart is handled in App Layout */}
